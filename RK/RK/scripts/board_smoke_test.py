...
TESTS = [
    (
        ...
        "wget -O main http://8.129.31.210/rk/main && "
        "wget -O touch_test http://8.129.31.210/rk/touch_test && "
        "wget -O camera_capture http://8.129.31.210/rk/camera_capture && "
        "chmod +x main touch_test camera_capture && "
        "./main -h && ./touch_test -h && ./camera_capture -h",
        30,
    ),
    (
        "lcd_main",
        "killall -9 rk356x-demo 2>/dev/null || true; /userdata/vision/bin/main /userdata/vision/res/flag.bmp",
        15,
    ),
    (
        "touch_3s",
