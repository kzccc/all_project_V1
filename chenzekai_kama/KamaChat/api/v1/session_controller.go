...
// @Accept json
// @Produce json
// @Param body body request.OpenSessionRequest true "打开会话请求"
// @Success 200 {object} SwaggerResponse
// @Router /session/openSession [post]
...
// @Success 200 {object} SwaggerResponse
// @Router /session/getUserSessionList [post]
...
// @Param body body request.OwnlistRequest true "用户ID"
// @Success 200 {object} SwaggerResponse
// @Router /session/getGroupSessionList [post]
...
// @Accept json
// @Produce json
// @Param body body request.DeleteSessionRequest true "删除会话请求"
// @Success 200 {object} SwaggerResponse
// @Router /session/deleteSession [post]
...
// @Accept json
// @Produce json
// @Param body body request.CreateSessionRequest true "会话检查请求"
// @Success 200 {object} SwaggerResponse
// @Router /session/checkOpenSessionAllowed [post]
