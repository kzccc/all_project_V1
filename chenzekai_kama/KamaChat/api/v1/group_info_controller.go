...
// @Accept json
// @Produce json
// @Param body body request.CreateGroupRequest true "创建群聊请求"
...
// @Accept json
// @Produce json
// @Param body body request.CheckGroupAddModeRequest true "群聊ID"
// @Success 200 {object} SwaggerResponse
// @Router /group/checkGroupAddMode [post]
...
// @Accept json
// @Produce json
// @Param body body request.EnterGroupDirectlyRequest true "直接进群请求"
// @Success 200 {object} SwaggerResponse
// @Router /group/enterGroupDirectly [post]
...
// @Accept json
// @Produce json
// @Param body body request.LeaveGroupRequest true "退群请求"
// @Success 200 {object} SwaggerResponse
// @Router /group/leaveGroup [post]
...
// @Accept json
// @Produce json
// @Param body body request.DismissGroupRequest true "解散群聊请求"
// @Success 200 {object} SwaggerResponse
// @Router /group/dismissGroup [post]
...
// @Accept json
// @Produce json
// @Param body body request.GetGroupInfoRequest true "群聊ID"
// @Success 200 {object} SwaggerResponse
// @Router /group/getGroupInfo [post]
...
// @Produce json
// @Success 200 {object} SwaggerResponse
// @Router /group/getGroupInfoList [post]
...
// @Accept json
// @Produce json
// @Param body body request.DeleteGroupsRequest true "群聊ID列表"
// @Success 200 {object} SwaggerResponse
// @Router /group/deleteGroups [post]
...
// @Accept json
// @Produce json
// @Param body body request.SetGroupsStatusRequest true "群聊状态请求"
// @Success 200 {object} SwaggerResponse
// @Router /group/setGroupsStatus [post]
...
// @Accept json
// @Produce json
// @Param body body request.UpdateGroupInfoRequest true "更新群聊信息请求"
// @Success 200 {object} SwaggerResponse
// @Router /group/updateGroupInfo [post]
...
// @Accept json
// @Produce json
// @Param body body request.GetGroupMemberListRequest true "群聊ID"
// @Success 200 {object} SwaggerResponse
// @Router /group/getGroupMemberList [post]
...
// @Accept json
// @Produce json
// @Param body body request.RemoveGroupMembersRequest true "移除群聊成员请求"
// @Success 200 {object} SwaggerResponse
// @Router /group/removeGroupMembers [post]
