#!/usr/bin/env python3
"""汇总 benchmark 与运行工件，生成 resume 指标产物。"""
...
from hepilot.metrics import collect_resume_metrics, render_resume_metrics_markdown  # noqa: E402


def build_arg_parser():
    """声明脚本支持的输入工件与输出路径参数。"""
    parser = argparse.ArgumentParser(description="Collect Hepilot resume metrics from benchmark and run artifacts.")
