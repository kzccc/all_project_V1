...
describe('BackgroundProcessManager.registerAgentTask — timeoutMs', () => {
  ...
  // scream-code do NOT carry an implicit default timeout. The Python
  // scream-cli enforced a 30-min default because its agents were
  // expected to be short-lived; scream-code's agents may legitimately
  ...
  // Contract decision (2026-05-21): scream-code treats `timeoutMs: 0`
