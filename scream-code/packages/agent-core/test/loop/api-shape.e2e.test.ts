...
import type { ContentPart, ModelCapability, TokenUsage } from '@scream-cli/ltod';
...
function _typeOnlyChecks(): void {
  ...
  void _badStop1;
  // @ts-expect-error - max_steps is represented by a thrown ScreamError, not StopReason.
