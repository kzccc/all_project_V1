...
export class ToolCallDeduplicator {
  ...
  private readonly stormWindow: Array<{ key: string }> = [];
  private readonly stormWindowSize = 6;
  private readonly stormThreshold = 3;
