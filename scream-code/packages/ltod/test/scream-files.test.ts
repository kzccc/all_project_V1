...
import { ScreamFiles } from '#/providers/scream-files';
import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';

function createProvider(): ScreamChatProvider {
...
describe('ScreamFiles', () => {
  ...
  describe('exposure on ScreamChatProvider', () => {
    it('exposes files property returning a ScreamFiles instance', () => {
      const provider = createProvider();
      const files = provider.files;
      expect(files).toBeInstanceOf(ScreamFiles);
