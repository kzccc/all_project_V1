...
export interface ChatProvider {
  /** Short identifier for the provider backend (e.g. `"scream"`, `"anthropic"`). */
  readonly name: string;
  /** Model name passed to the upstream API (e.g. `"scream-cli-v1-auto"`). */
   ...
   * original. See `ScreamChatProvider._clone()` for the rationale.
   */
